...
public partial class ApplicationDbContext : DbContext
{
    ...
    public virtual DbSet<Eslam> Eslams { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E2789A704CE");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4B28B5D70");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB856B45F33F");

            entity.ToTable("customers", "sales");

            entity.HasIndex(e => e.State, "A");

            entity.HasIndex(e => e.City, "SS");
        ...
        modelBuilder.Entity<Eslam>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ESLAM");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229BA6B1BF7");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4C7ACD4CD");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF587407801");
        ...
        {
            entity.HasKey(e => e.PromotionId).HasName("PK__promotio__2CB9556BDB1FF929");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C8D30116A");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164CE60A23B").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3F3A12FE6");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C65D11B0F");
